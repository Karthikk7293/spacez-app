...
const DeleteAccount = ({ tooltip, Icon, text }: LogoutButtonTypes) => {
    return (
        <div role='button' className=' relative active:bg-gray-100 md:border-[#B82B14] flex cursor-pointer justify-between items-center pt-6 pb-3 md:border rounded px-2'>
            <span className='absolute left-4 top-1 text-xs hidden md:block '>{tooltip}</span>
            <div className="flex  items-center gap-3 text-[#B82B14]  ">
                <span className=''>
